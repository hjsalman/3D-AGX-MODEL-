...
| mmWave (antenna on X0) | -35.5 to 54.5 | -8.0 to 26.0 | 86.2 to 188.2 |
...
Antenna centered on X0: the real antenna array sits 9.5 mm sideways and 21.6 mm up from the
mounting-hole center (measured from TI IWR Gerber). Mounting holes are shifted +9.5 mm in X so
the actual antenna array (not the board center) lands on the ZED centerline. Antenna elevation
is hole-center + 21.6 mm.
