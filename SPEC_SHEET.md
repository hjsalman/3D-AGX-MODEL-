...
|---|---|---|---|---|---|---|
| mmWave DCA1000 | M3 | 4 | 76.30 x 56.89 | tapped M3 in the 15 mm standoffs | Ø8 x 2 seat on board | M3 x 20 (thru DCA + 15 standoff) |
| ZED 2i | M3 | 4 | 153.4 x 14 | Ø3.4 clearance thru plate | Ø8 x 2 seat + M3 nut (or ZED insert) | M3 x 8 |
| Jetson AGX | M3 | 4 | 97 x 97 | tapped M3 in printed bosses (Ø8 x 6) | Ø9 x 3 counterbore under floor | M3 x 12 |
| IMU (Phidgets 1205) | M2 | 4 | 22.86 x 27.94 | tapped M2 in front wall | Ø9 x 3 counterbore | M2 x 6 |
| Handles (each) | M3 | 2 | 46 apart | Ø3.4 clearance thru wall | captive M3 hex nut, 6.6 AF x 2.6 | M3 x 18 |

Standoffs: 4x Ø8 mm posts, 15 mm tall, tapped M3 (mmWave DCA mount).
...
- Tapped holes are modeled with real ISO threads (M3 = 0.5 pitch, M2 = 0.4 pitch)
