...
module imu_mount(){   // 4x M2 through the FRONT wall; IMU mounts inside, left of the mmWave
    translate([imu_cx,-eps,rad_cz]) rotate([-90,0,0]) holes4(imu_hole_dx,imu_hole_dy) cylinder(d=imu_screw,h=wall+2*eps);
...
// render select (default assembly; -D 'part="box_body"' to override)
part="assembly";
